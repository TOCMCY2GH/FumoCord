...
start "" "%WEZ%" start -- cmd /K "cd /d %PROJECT_ROOT% && chcp 65001 & dart run bin\server.dart"
start "" "%WEZ%" start -- cmd /K "cd /d %PROJECT_ROOT% && chcp 65001 & dart run bin\admin.dart"
start "" "%WEZ%" start -- cmd /K "cd /d %PROJECT_ROOT% && chcp 65001 & dart run bin\client.dart"
start "" "%WEZ%" start -- cmd /K "cd /d %PROJECT_ROOT% && chcp 65001 & dart run bin\client.dart"
